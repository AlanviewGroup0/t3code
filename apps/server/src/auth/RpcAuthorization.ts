...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.harnessPreviewStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.harnessPreviewStop]: AuthOrchestrationOperateScope,
  [WS_METHODS.harnessPreviewList]: AuthOrchestrationReadScope,
